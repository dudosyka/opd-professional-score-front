...
export default {
  ...
  void main() {
    ...
    changeToAccent() {
      this.options.perlin.rcolor = 4.5;
      this.options.perlin.qcolor = 3.5;
      this.options.perlin.bcolor = 9.5;
      this.animation();
    },
    changeToWhite() {
      this.options.perlin.rcolor = 1.6;
      this.options.perlin.qcolor = 0.4;
    ...
    endGame() {
      ...
      console.log(document.getElementsByTagName('canvas')[0].remove());
